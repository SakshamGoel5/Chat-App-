    ...
    <main className='p-4'>
      ...
      { !loading &&
        projects.map((project) => (
          <div key={project._id} onClick={()=> {navigate(`/project` , {state: {project}})}} className='project flex flex-col gap-2 p-4 border border-slate-300 rounded-md min-w-52 hover:bg-slate-200 cursor-pointer'>
